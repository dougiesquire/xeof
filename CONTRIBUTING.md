...
6. Start making and committing your edits, including adding tests to `xeof/tests` to check that your contributions are doing what they're suppose to. To run the test suite:
